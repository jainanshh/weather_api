...
import {
  ...
  generateBirminghamWeatherData,
  generateKentWeatherData,
...
export const getWeatherData = async (req: Request, res: Response) => {
  ...
  try {
    ...
    } else if (city === "Brimingham") {
      finalWeatherData = generateBirminghamWeatherData();
    } else if (city === "Kent") {
      finalWeatherData = generateKentWeatherData();
    } else {
